import { Svg, G, Path, Stop, LinearGradient } from "@react-pdf/renderer"
  ...
  return (
    ...
    >
      <g transform="translate(-130,-845) scale(3)">
        <linearGradient id="c" x1={127.83} x2={132.8135} y1={371.1169} y2={296.3658}>
...
export function PdfSvgComponent() {
  return (
    <Svg
      height={36}
      viewBox="0 0 500 500"
    ...
    >
      <G transform="translate(-130,-845) scale(3)">
        ...
        <Path
          ...
          fill="url(#c)"
        />
        <LinearGradient id="d" x1={131.8699} x2={160.9399} y1={423.8904} y2={317.9924}>
          <Stop offset={0} stopColor="#6e45a7" />
          <Stop offset={0.4017} stopColor="#8e2b96" />
          <Stop offset={1} stopColor="#c4007a" />
        </LinearGradient>
        <Path
          ...
          opacity={0.9}
        />
        <LinearGradient id="e" x1={55.9509} x2={144.2279} y1={365.2427} y2={365.2427}>
          <Stop offset={0} stopColor="#6e45a7" />
          <Stop offset={0.4017} stopColor="#8e2b96" />
          <Stop offset={1} stopColor="#c4007a" />
        </LinearGradient>
