...
function Category() {
  ...
  if (products.length === 0) {
    return (
      <section className="w-auto p-4 h-full flex flex-col">
        <svg
        ...
        <Alert className="mb-3" variant={"warn"}>
          <div className="grid">
            <AlertTitle>Categoria Inexistente</AlertTitle>
            <AlertDescription>La categoria no inexistente</AlertDescription>
          </div>
        </Alert>
